                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p>Các học viên tại ILA sẽ trở thành công dân toàn cầu với tư duy tích cực và tầm nhìn mở rộng, các em không chỉ xuất sắc tiếng Anh mà còn phát triển 6 kỹ năng vàng của thế kỷ 21: Khả năng sáng tạo, tư duy phản biện, kỹ năng giao tiếp, kỹ năng hợp tác, khả năng tự hoàn thiện bản thân, kiến thức công nghệ.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="each-product-detail">
                        <div class="content-detail">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>Trại hè ILA 2018 như cột mốc đầu tiên trong hành trình khơi gợi đam mê tiếng Anh , nơi các bé được trò chuyện, vui chơi và suy nghĩ bằng tiếng Anh cả ngày với những những hoạt động ngoại khoá cực vui được thiết kế bởi đội ngũ giáo viên đầy tâm huyết của ILA liên kết với các đối tác uy tin nhất.</p>
                        ...
                        <div class="img-event-detail">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-2">
                                        <img src="{!! asset('public/assets/frontend/images/program/enrichment/lego.jpg') !!}" class="img-responsive" alt="CLB Lego">
                                    </div>
                                    <div class="col-md-2">
                                        <img src="{!! asset('public/assets/frontend/images/program/superjuniors/dance.jpg') !!}" class="img-responsive" alt="CLB âm nhạc">
                                    </div>
                                    <div class="col-md-2">
                                        <img src="{!! asset('public/assets/frontend/images/program/superjuniors/mythuat.jpg') !!}" class="img-responsive" alt="CLB bóng rổ">
                                    </div>
                                    <div class="col-md-2">
