                    ...
                    <div class="content-program-container">
                        <div class="container-fluid">
                            <div class="row each-program align-items-center">
                                <div class="col-md-4">
                                    <div class="wrap-img-program " data-animate="fadeInLeft">
                                        <img src="{!! asset('public/assets/frontend/images/keypoint/caothutienganh.png') !!}" class="img-responsive" alt="Cao Thủ Tiếng Anh">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="content-program " data-animate="fadeInRight">
                                        <p>Phương pháp học tư duy thế kỷ 21 cùng 6 kỹ năng vàng được nghiên cứu và phát triển từ những chuyên gia giáo dục hàng đầu, trại hè ILA 2018 sẽ đánh thức niềm đam mê ngoại ngữ ở học viên.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row each-program align-items-center">
                                <div class="col-md-4 col-md-push-8">
                                    <div class="wrap-img-program " data-animate="fadeInLeft">
                                        <img src="{!! asset('public/assets/frontend/images/keypoint/xaydungtinhcach.png') !!}" class="img-responsive" alt="Xây Dựng Tính Cách">
                                    </div>
                                </div>
                            ...
                            <div class="row each-program align-items-center">
                                <div class="col-md-4">
                                    <div class="wrap-img-program " data-animate="fadeInLeft">
                                        <img src="{!! asset('public/assets/frontend/images/keypoint/sanseyeuthuong.png') !!}" class="img-responsive" alt="San Sẻ Yêu Thương">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="content-program " data-animate="fadeInRight">
